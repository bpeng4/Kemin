...
no_of_cores = 36
load("./intermediate/Forward.rda")
ls()
gc(full=TRUE) 
metadata<-read.csv(file="/lustre/work/benson/bpeng4/Kemin/Kemin_All/SampleSheet_Final.csv")
...
rownames(metadata_df)<-metadata[,1]
...
save(ps, file = "intermediate/Kemin_ps.rda")
